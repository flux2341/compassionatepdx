...
endorsement_businesses = [{
  ...
  url: 'http://www.ebandbean.com/'
},{
  name: 'Tabor Bread',
  logo: 'tabor_bread.png',
  ...
  name: 'Solutions Chiropractic',
  logo: null,
  url: 'https://solutionschiro.net/'
},{
  name: 'Misty Fall Body Works',
  logo: null,
  url: 'https://www.mistyfallbodyworks.com/'
},{
  name: 'Dream Into Change',
  logo: null,
  url: 'https://www.dreamintochange.com/'
},{
  name: 'Happy to Listen',
  logo: null,
  url: 'https://www.happytolisten.com/'
}]